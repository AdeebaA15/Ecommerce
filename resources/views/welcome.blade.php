...
.input-group-append .btn-secondary {
    ...
    border-color: #f26522;
    color: #fff;
    /* Optional: Ensures the text/icon color contrasts well */
...
.input-group-append .btn-secondary:active {
    ...
    /* Slightly darker shade for focus/active effect */
    border-color: #c7461b;
    box-shadow: none;
...
.input-group .form-control {
    border-right: 0;
    /* Removes the border between input and button */
}
    ...
    <div class="banner_bg_main">
        ...
        <div class="logo_section">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="logo"><a href="index.html"><img src="assets/images/logo1.jpg"
                        style="mix-blend-mode: color-burn; width: 100px;"></a></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="fashion_section_2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4 center-text">
                                    <a href="{{ route('all.products', ['category_id' => $category->id]) }}"
                                        class="btn btn-secondary btn-sm"
                                        style="background-color: #F97300; height:39px;padding-top:8px;border-color:#F97300;border-radius:33px 22px ;box-shadow:2px 9px 2px 2px #F5EFE6">View
                                        More </a>
